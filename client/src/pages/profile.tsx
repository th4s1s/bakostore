                    ...
                    <><div className="flex h-screen bg-white justify-center place-items-start">
                        <div className="w-6/12 bg-white rounded-lg border border-pink-500 shadow-default py-10 px-16 mt-5">
                            <div className='w-full flex items-end justify-end'>
                                <button className='rounded-lg border-2 p-1 right-0 bg-pink-500 text-white font-bold py-2 px-4 rounded' onClick={() => { setEditMode(false); setTmpAvt(null); setTmpName(null); setTmpPhone(null)} }>

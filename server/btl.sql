...
Bản thân tác giả cũng từng phát biểu rằng đây là đặc điểm khiến tác phẩm “rất khó chuyển thể”, và thực tế thì “hội thoại” chính là điểm nhấn mà các phiên bản anime hay manga, tuy đều rất nỗ lực và đạt được thành công mỹ mãn với cách thể hiện của mình, song vẫn chưa thể truyền tải trọn vẹn tới người đọc/người xem.', '/img/news/default.png');

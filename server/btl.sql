...
('Khẽ hát lời yêu - Tập 4', 'Sau khi thấu hiểu cảm xúc của nhau, Yori và Himari đã trở thành một cặp và tận hưởng cuộc sống học đường đầy sắc màu. Tuy đã đạt được mục tiêu, Yori vẫn tiếp tục làm hát chính cho ban nhạc SSGIRLS. Tuy nhiên, cả ban nhạc bỗng gặp lại Shiho, một thành viên cũ. Câu chuyện về quá khứ của ban nhạc SSGIRLS dần được hé lộ.', 65000, '/img/product/sasakoi_4.jpg', 'manga'),
...
('Hành Trình Của Elaina - Tập 3', 'Cô ấy là một phù thủy, và cũng là lữ khách. Cô khoác lên mình tấm áo choàng đen cùng một chiếc mũ chóp nhọn màu đen, huy hiệu chứng minh cho thân phận nữ phù thủy lấp lánh trên ngực áo. Mái tóc lộ ra dưới vành nón là màu xám tro tung bay đón lấy những cơn gió lạnh. Đôi mắt màu xanh biếc đang chăm chú nhìn vào một quốc gia nho nhỏ nằm yên tĩnh nơi tiếp giáp giữa bầu trời xanh và bình nguyên. Cô gái ấy chính là tôi - Phù Thủy Tro Tàn Elaina.\nChẳng ngờ một ngày tôi lại gặp rắc rối vì thứ "Thuốc biến đồ vật thành con người" do chính mình chế tạo ra. Kỳ này tôi đã học được bài học về sức mạnh đáng sợ khi đồ vật nổi dậy - thật may tôi lại được cây chổi yêu quý của mình cứu giúp. Chuyến đi lần này không thiếu những trải nghiệm kịch tính, dở khóc dở cười, có thú vị mà cũng có cả kinh hãi tột độ: bất đắc dĩ trở thành "quý cô giẫm nho", du hành ngược thời gian, gặp những bản sao khác nhau của chính mình... nhưng đau lòng nhất vẫn là mất đi mái tóc dài T_T', 98000, '/img/product/elaina_3.png', 'novel'),
...
('Hành Trình Của Elaina - Tập 4', 'Cô ấy là một phù thủy, và cũng là lữ khách. Cô khoác lên mình tấm áo choàng đen cùng một chiếc mũ chóp nhọn màu đen, huy hiệu chứng minh cho thân phận nữ phù thủy lấp lánh trên ngực áo. Mái tóc lộ ra dưới vành nón là màu xám tro tung bay đón lấy những cơn gió lạnh. Đôi mắt màu xanh biếc đang chăm chú nhìn vào một quốc gia nho nhỏ nằm yên tĩnh nơi tiếp giáp giữa bầu trời xanh và bình nguyên. Cô gái ấy chính là tôi - Phù Thủy Tro Tàn Elaina.\nChẳng ngờ một ngày tôi lại gặp rắc rối vì thứ "Thuốc biến đồ vật thành con người" do chính mình chế tạo ra. Kỳ này tôi đã học được bài học về sức mạnh đáng sợ khi đồ vật nổi dậy - thật may tôi lại được cây chổi yêu quý của mình cứu giúp. Chuyến đi lần này không thiếu những trải nghiệm kịch tính, dở khóc dở cười, có thú vị mà cũng có cả kinh hãi tột độ: bất đắc dĩ trở thành "quý cô giẫm nho", du hành ngược thời gian, gặp những bản sao khác nhau của chính mình... nhưng đau lòng nhất vẫn là mất đi mái tóc dài.', 98000, '/img/product/elaina_4.png', 'novel'),
...
Bản thân tác giả cũng từng phát biểu rằng đây là đặc điểm khiến tác phẩm "rất khó chuyển thể", và thực tế thì "hội thoại" chính là điểm nhấn mà các phiên bản anime hay manga, tuy đều rất nỗ lực và đạt được thành công mỹ mãn với cách thể hiện của mình, song vẫn chưa thể truyền tải trọn vẹn tới người đọc/người xem.', '/img/news/new1.png'),

('2024-05-04', 'BIẾN TẤU DIOGENES: TỔ KHÚC ĐẶC SẮC ĐÁNH DẤU 10 NĂM SÁNG TÁC CỦA NHÀ VĂN TRINH THÁM ĂN KHÁCH CHAN HO KEI', 'Đánh dấu 10 năm sáng tác bền bỉ, Chan Ho Kei ra mắt tập truyện ngắn Biến Tấu Diogenes gồm 17 tác phẩm đủ các thể loại trinh thám, kinh dị, kỳ bí, giả tưởng,... Nay đã được ra mắt bạn đọc phiên bản tiếng Việt.

Một Chan Ho Kei vừa lạ vừa quen

Nếu đã "làm quen" Chan Ho Kei qua 13.67 với những pha phá án khiến người đọc ngơ ngác nghẹt thở, hoặc Người Trong Lưới với những tình tiết tinh vi trên không gian mạng, hay Hình Cảnh Mất Trí rất... "mất trí", thì tới Biến Tấu Diogenes, bạn đọc sẽ gặp lại những khúc cua đậm chất Chan Ho Kei.

Một Chan Ho Kei vừa lạ vừa quen, có lẽ cũng đã đủ để mô tả phong cách sáng tác trong Biến Tấu Diogenes. Trong cuốn sách này, bạn gặp lại những tình tiết lắt léo và thủ pháp cá trích đỏ quen thuộc mà Chan Ho Kei thường dùng. Hơn thế nữa, độc giả có thêm cơ hội thưởng thức những ý tưởng mới lạ của nhà văn người Hồng Kông này.

Mười bảy truyện ngắn và truyện cực ngắn được sắp xếp và trình bày như một bản nhạc, tấu thành một tổ khúc đặc sắc đánh dấu mười năm sáng tác của Chan Ho Kei.

Mười bảy truyện ngắn và cực ngắn gồm nhiều thể loại từ kinh dị, giả tưởng, trinh thám, tâm linh, tâm thần,... không một ý tưởng trùng lặp, đưa độc giả đi hết từ bất ngờ này đến bất ngờ khác.

Ai là người đã giết ông già Noel (truyện ngắn Án Mạng Ông Già Noel)? Tại sao trên đầu mọi người đều xuất hiện một sinh vật kì dị nào đó nhưng họ lại không hề hay biết (truyện ngắn Đỉnh Đầu)? Tại sao nhà văn vốn chỉ cầm bút bằng tay, nay lại dùng tay để giết người (truyện ngắn Vụ Án Giết Người Của Nhà Văn Trẻ)? Sẽ ra sao nếu một kẻ biến thái theo dõi blog cá nhân của bạn (truyện ngắn Lam Rình Lam)?...

Trong Biến Tấu Diogenes có vô vàn những tình tiết gây tò mò như thế. Bước vào cuốn sách là bước lên hành trình thưởng thức say sưa không lối về. Ý tưởng mới lạ, tình tiết lắt léo, cái kết khiến người đọc ngỡ ngàng...

Dù là kinh dị, giả tưởng hay trinh thám, cũng đều hướng đến con người

Đọc Chan Ho Kei, bạn đọc dễ nhận ra điều cuối cùng nhà văn này muốn hướng đến đều là con người. Dẫu tình tiết có bất nhân hay nhân vật vô đạo đức, khốn nạn đến đâu, cái chiêm nghiệm ta rút ra từ những câu chuyện của Chan Ho Kei đều xoay quanh con người và đạo đức.

Ấy là một người không biết trân trọng hiện tại, chỉ muốn nhảy cóc đến tương lai, chạm tới viễn cảnh của thành công (truyện ngắn Thời Gian Là Vàng Bạc), hay sáng tạo ra vụ án mạng thảm khốc của ông già Noel để trỏ tới vai trò của cá nhân trong các ràng buộc xã hội (truyện ngắn Án Mạng Ông Già Noel), hoặc chứng bệnh liên quan đến tâm thần của một kẻ nghiện thuốc lá ngẫu nhiên thế nào lại thành tiền đề cho một kẻ phạm tội...

Trong vũ trụ của Chan Ho Kei, đạo đức luôn là bài học cuộc sống và câu hỏi cuối cùng được đưa ra. Nhưng thế không có nghĩa là mọi cái kết đều vẹn toàn. Cái hay của Chan Ho Kei là ở chỗ ấy, sau khi đọc xong rồi mà vẫn còn suy nghĩ, vẫn còn choáng ngợp, vẫn còn băn khoăn mãi khôn nguôi.

Và khi gấp sách lại (hoặc ngay khi cầm sách lên), hẳn nhiều độc giả sẽ tự hỏi: Diogenes là gì? Là tên một bản nhạc ư? Hay đúng hơn, Diogenes là ai?
...
Dù có phép thuật, có những tồn tại vượt quá sức tưởng tượng, có những yêu quái khác xa người thường, thì những tình huống và bài học mà nhân vật phải đối mặt cũng không khác gì cuộc sống ngoài kia. Nếu bạn đang muốn tìm một câu chuyện mượn yếu tố kì ảo để gửi gắm thông điệp nhân văn, vậy Bako gợi ý bạn 4 oneshot novel hay ho sau.

BẦU TRỜI XANH CỦA EM

"Chú ếch nơi đáy giếng không biết đến đại dương, nhưng lại biết sắc xanh của bầu trời."

Aioi Aoi là một nữ sinh cấp ba sống ở thị trấn vùng núi. Đương lúc các bạn đồng trang lứa đang suy nghĩ về con đường tương lai, Aoi lại chỉ chìm đắm trong niềm yêu thích âm nhạc. Cũng vào thời điểm này, một cuộc gặp gỡ ngoài mong đợi đã xảy ra…

Aoi có một chị gái tên là Akane. Một ngày nọ, Shinnosuke - bạn trai cũ của Akane quay lại thị trấn. Trong khi Akane hội ngộ người xưa sau mười ba năm, cô em gái Aoi cũng đột ngột gặp được "Shinno" - tức Shinnosuke trong hình dáng thời cấp ba, và bắt đầu có những rung động đầu đời…

"Mối tình đầu lần thứ hai" gõ cửa, với quá khứ và hiện tại đan xen.

BẦU TRỜI XANH CỦA EM là một tác phẩm đến từ nhóm sáng tạo Cho-Heiwa Busters, những người đứng đằng sau ANOHANA - ĐÓA HOA NGÀY ẤY. Dưới ngòi bút của Nukaga Mio, những niềm đau, niềm trăn trở của tuổi trẻ hiện lên sống động, thực tế và khiến người ta đồng cảm hơn bao giờ hết.

KHI MUỐN KHÓC, TÔI ĐEO MẶT NẠ MÈO

"Có lẽ trong đêm hội nọ, tôi đã chán ngấy việc làm người rồi. Tôi ghét bố mẹ, gia đình đến mức cầu mong thế giới diệt vong. Vì vậy, tôi mới tình cờ gặp sạp hàng kia, rồi có được chiếc mặt nạ hóa mèo."

Để được ở bên người mình mến, Miyo chấp nhận đeo mặt nạ để biến thành mèo Taro. Để bày tỏ thẳng thắn cảm xúc của bản thân, cô chấp nhận biệt danh Muge (kẻ kì quái vô cực), để thỏa thích giải phóng năng lượng của bản thân trên trường lớp (hoặc nhảy từ tầng hai xuống để xử lý kẻ nói xấu crush của mình).

Còn tên thật Miyo thì sao? Ấy là tên cha mẹ đặt cho, nhưng cô không có tình cảm sâu sắc gì với nó. Thậm chí, nó ấn định danh tính mà Miyo cực kỳ ghét, bởi sự rạn vỡ trong mối quan hệ với cha mẹ từ thuở bé đã khiến cô không thể mở lòng với những người gần gũi mình nhất.

Theo đó, KHI MUỐN KHÓC, TÔI ĐEO MẶT NẠ MÈO không chỉ là câu chuyện về hành trình thú vị của một cô gái sống cùng lúc hai cuộc đời: Đời người và đời mèo. Tác phẩm còn nhẹ nhàng đặt ra một câu hỏi đáng suy ngẫm về danh tính cá nhân: Làm sao để là chính mình, khi mà xã hội gán cho ta vô vàn danh tính?

Có thể bạn sẽ tìm thấy câu trả lời qua cuốn sách rất đỗi nhẹ nhàng và nhiều phép màu này.

TẶNG HOA CHO QUÁI VẬT TRONG RỪNG
...
Rừng già âm u đầy rẫy hiểm nguy lại là nơi nảy nở những giác ngộ quý giá và tình cảm nguyên sơ, làm đổi thay không chỉ cuộc sống của Cleo, mà còn của cả dân chúng, của nếp sống và truyền thuyết bao đời trong vùng.
